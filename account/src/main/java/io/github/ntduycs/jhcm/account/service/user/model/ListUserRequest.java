...
public class ListUserRequest {
  ...
  @Pattern(regexp = "username|name|cifNumber|status|updatedAt")
  @Schema(
      description = "Sort field",
      defaultValue = "updatedAt",
      allowableValues = {"username", "name", "cifNumber", "status", "updatedAt"})
  ...
  @Schema(description = "Search by username containing")
  private String username;

  @Schema(description = "Search by name containing")
  private String name;

  @Schema(description = "Search by CIF number containing")
